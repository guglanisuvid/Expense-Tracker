    ...
    return (
        <div
            ...
            <div
                ...
                <h1 className='text-2xl font-semibold'>{expensesChart ? 'Expense' : 'Income'} Statistics</h1>
                <button
                    className={`hover:underline underline-offset-[6px] transition-all duration-300 ease-in-out ${expensesChart ? 'text-[#5C8D7B]' : 'text-[#E35933]'}`}
